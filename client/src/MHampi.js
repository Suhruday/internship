...
function MHampi() {
  ...
  const visiters = [
    { year: "2023", people: 584 },
    { year: "2024", people: 843 },
    { year: "2025", people: 373 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://karnatakatourism.org/wp-content/uploads/2020/05/Hampi.jpg")`,
  ...
  return (
    <div className="aa" style={backgroundStyle}>
      ...
      <p><i>
        Hampi is a fascinating UNESCO World Heritage site offering a blend of ancient history, natural beauty, and religious sites. It's the ruins of the Vijayanagara Empire, showcasing remarkable architecture, temples, and a vibrant bouldering scene.
      </i></p>

...
function MHampi() {
  ...
  const visiters = [
    { year: "2023", people: 546 },
    { year: "2024", people: 737 },
    { year: "2025", people: 594 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://www.captureatrip.com/_next/image?url=https%3A%2F%2Fcaptureatrip-cms-storage.s3.ap-south-1.amazonaws.com%2FPlaces_To_Visit_in_Ooty_Tamil_Nadu_b092016ad1.webp&w=3840&q=50&dpl=dpl_HiCh2AFG23jcCkxPQZwzepTMULbv")`,
  ...
  return (
    <div className="aa" style={backgroundStyle}>
      ...
      <p><i>
        Ooty, or Udhagamandalam, is a picturesque hill station in Tamil Nadu, India, often called the "Queen of the Hills". It's known for its stunning natural beauty, pleasant climate, and colonial-era architecture, making it a popular destination for tourists seeking a serene getaway. 
      </i></p>

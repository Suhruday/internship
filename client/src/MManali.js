...
function MHampi() {
  ...
  const visiters = [
    { year: "2023", people: 637 },
    { year: "2024", people: 846 },
    { year: "2025", people: 373 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://manalitourism.co.in/images/places-to-visit/headers/old-manali-snow-point-header-manali-tourism.jpg.jpg")`,
  ...
  return (
    <div className="aa" style={backgroundStyle}>
      <div style={{ display: "flex", justifyContent: "center" }}>
        <h1><b><i>MANALI</i></b></h1>
      </div>
      <p><i>
        Manali is a charming hill station nestled in the heart of the Western Himalayas, offering a perfect blend of natural beauty and adventure. 
      </i></p>

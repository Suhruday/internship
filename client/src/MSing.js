...
function MSing() {
  ...
  const visiters = [
    { year: "2023", people: 397 },
    { year: "2024", people: 589 },
    { year: "2025", people: 375 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://www.ootlah.com/wp-content/uploads/2018/12/https___blogs-images.forbes.com_alexcapri_files_2018_09_Singapore-1200x800.jpg")`,
  ...
  return (
    <div className="aa" style={backgroundStyle}>
      <div style={{ display: "flex", justifyContent: "center" }}>
        <h1><b><i>SINGAPORE</i></b></h1>
      </div>
      <p><i>
        Singapore, also known as the "Lion City," is a vibrant island nation in Southeast Asia, offering a blend of modern and historical attractions, diverse cultures, and a thriving culinary scene. It's a popular destination for tourists seeking a mix of urban exploration, shopping, and delicious food. 
      </i></p>

...
function MParis() {
  ...
  const visiters = [
    { year: "2023", people: 150 },
    { year: "2024", people: 203 },
    { year: "2025", people: 186 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://cdn.holidayguru.ch/wp-content/uploads/2017/10/Beach-in-Goa-iStock-157579910.jpg")`,

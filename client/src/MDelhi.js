...
function MHampi() {
  ...
  const visiters = [
    { year: "2023", people: 794 },
    { year: "2024", people: 853 },
    { year: "2025", people: 494 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://travelersguider.com/wp-content/uploads/2024/02/places-to-visit-in-Delhi.webp")`,
  ...
  return (
    <div className="aa" style={backgroundStyle}>
      ...
      <p><i>
        Delhi is a vibrant and historic city that offers a unique blend of ancient and modern attractions, making it a captivating destination for tourists. 
      </i></p>

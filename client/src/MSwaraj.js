...
function MSwaraj() {
  ...
  const [pla] = useState("SWARAJ DWEEP");
  ...
  const visiters = [
    { year: "2023", people: 143 },
    { year: "2024", people: 173 },
    { year: "2025", people: 156 },
  ];

  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.7), rgba(255, 255, 255, 0.7)), url("https://media-cdn.tripadvisor.com/media/photo-p/24/fe/bb/3a/candle-light-dinner-in.jpg")`,
